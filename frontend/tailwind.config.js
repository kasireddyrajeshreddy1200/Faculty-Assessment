...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        sans: ['Segoe UI', 'Blinkmacsystemfont', 'Roboto', 'Arial', 'sans-serif'],
  ...
  plugins: [
    function ({ addUtilities }) {
      const newUtilities = {
        ...
        '.card-shadow': {
          '@apply shadow-[0_10px_30px_rgba(0,0,0,0.1)]': {},
        },
        '.input-focus': {
          '@apply focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 transition-all': {},
        },
      };
