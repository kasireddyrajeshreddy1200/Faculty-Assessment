          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8 flex items-center gap-4 animate-slide-in-down">
              <button
                ...
                className="px-6 py-2 bg-gradient-to-br from-green-400 to-green-500 text-white font-semibold rounded-lg hover:from-green-500 hover:to-green-600 transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
              >
